...
module.exports = function(app) {
    ...
    GenericRouter.get('/webapi/technicians', AuthenticationController.requiresAuth, TechnicianController.findAll);
    ...
    //Company
    GenericRouter.post('/webapi/addCompany', AuthenticationController.requiresAuth, CompanyController.add);
    GenericRouter.post('/webapi/delCompany', AuthenticationController.requiresAuth, CompanyController.delete);
    GenericRouter.post('/webapi/updateCompany', AuthenticationController.requiresAuth, CompanyController.update);
    ...
    GenericRouter.post('/webapi/updateSubZone', AuthenticationController.requiresAuth, SubZoneController.update);
     ...
     //Technician
    GenericRouter.post('/webapi/addTechnician', AuthenticationController.requiresAuth, TechnicianController.add);
