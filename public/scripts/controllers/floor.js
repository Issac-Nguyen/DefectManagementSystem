...
angular.module('angularTokenAuthApp.controllers')
    .controller('FloorController', ['$scope', '$state', '$http', 'Utils', 'Auth', '$modal', 'uiGridConstants', 'buildings', 'floors',
        function($scope, $state, $http, Utils, Auth, $modal, uiGridConstants, buildingsList, floorsList) {
